...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ?  'https://telegra.ph/file/87b1d8685ec69de52b51a.jpg' : process.env.ALIVE_LOGO,
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://telegra.ph/file/702f65a848c8b87db2342.gif' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://telegra.ph/file/e7d5e30d199dbdcde41cd.jpg' : process.env.GIF_BYE,
    CAPTION_KEY: process.env.CAPTION_KEY === undefined ?'made by MARAYA' : process.env.CAPTION_KEY,
    ...
    MENUTEXT: process.env.MENU_TEXT === undefined ?'*MARAYA💕*' : process.env.MENU_TEXT,
